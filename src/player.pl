...
landingGO(Pemain):-
    repeat,(
        ...
        (
            ...
            goBuildProperty(Pemain, LokasiPilihan),!
            ;
            LokasiPilihan == help,
...
goBuildProperty(Pemain, Lokasi):-
    /*aksi jika player mendarat di go lalu membangun property*/
                    ...
                    (
                        ...
                        InputPilihan == bangunan1,
                            ...
                            hargaProperti(LokasiBeli,_, HargaBeli,_,_,_),
                                (
                                    Uang < HargaBeli, write('Yahh... Uangmu tidak Cukup :('), write('Uangmu kurang $'), Kekurangan is (HargaBeli-Uang), write(Kekurangan), write('lagi!)'), nl ,fail
                                    ;
                                    Uang >= HargaBeli,
                                    write('Bangunan1 berhasil dibeli! '), nl,
                                    subtBalance(Pemain, HargaBeli),
                                    removePosession(Pemain, LokasiBeli),
                                    addPosession(Pemain, LokasiBeli, 'Bangunan1'),
                                    goBuildProperty(Pemain), !
                                )
                            )
                            ;
                            write('Kamu sudah memiliki tingkatan bangunan ini'), nl, fail
                        ...
                        hargaProperti(LokasiBeli,_, HargaBangunan1, HargaBangunan2,_,_),
                            ...
                            HargaBeli = (HargaBangunan1 + HargaBangunan2),
                                (
                                    ...
                                    ;
                                    Uang >= HargaBeli,
                                    write('Bangunan2 berhasil dibeli! '), nl,
                                    subtBalance(Pemain, HargaBeli),
                                    removePosession(Pemain, LokasiBeli),
                        ...
                        hargaProperti(LokasiBeli,_, HargaBangunan1,HargaBangunan2, HargaBangunan3,_),
                            ...
                            HargaBeli = (HargaBangunan1 + HargaBangunan2 + HargaBangunan3),
                                (
                                    ...
                                    ;
                                    Uang >= HargaBeli,
                                    write('Bangunan3 berhasil dibeli! '), nl,
                                    subtBalance(Pemain, HargaBeli),
                                    removePosession(Pemain, LokasiBeli),
                        ...
                        (
                            (
                                ...
                                (
                                    ...
                                    ;
                                    Uang >= HargaBeli,
                                    write('Landmark berhasil dibeli! '), nl,
                                    subtBalance(Pemain, HargaBeli),
                                    removePosession(Pemain, LokasiBeli),
                                    addPosession(Pemain, LokasiBeli, 'Landmark'),!
                                )
                                ;
                                (KaliLewat2 < 1 ; CurrentTingkat \= 'Bangunan3'),
                        ...
                        InputPilihan == cancel
                        ;
                        (InputPilihan \= help), (InputPilihan \= landmark), (InputPilihan \= bangunan1), (InputPilihan \= bangunan2), (InputPilihan \= bangunan3), (InputPilihan \= cancel),
    ...
    (
        ...
        (
            ...
            (
                ...
                nl, write('Saldo Player P1: '), printBalance(p1), nl,nl, write('Saldo Player P2: '), printBalance(p2),nl,nl
                ;
                Answer == n, write('Kartu sakti tidak digunakan'), nl
                ;
                Answer \= y, Answer \= n, write('Input tidak valid'), nl, nl, fail
            )
        )
        ;
        \+ card(Pemain, 6)
    ...
    (
        ...
        (repeat, 
            ...
            (
                ...
                InputPilihan == cancel,!
                ;
                (InputPilihan \= help), (InputPilihan \= landmark), (InputPilihan \= tanah), (InputPilihan \= bangunan1), (InputPilihan \= bangunan2), (InputPilihan \= bangunan3), (InputPilihan \= cancel),
                write('Input tidak valid'), nl, nl, fail
            )    
        )
        ;
