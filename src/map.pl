...
printMap :- nl, nl, write('             '),write('          '),(printOwner(e1,_);write('        ')),write(' '),(printOwner(e2,_);write('        ')),write(' '),(printOwner(e3,_);write('        ')),write(' '),write('        '),write(' '),(printOwner(f1,_);write('        ')),write(' '),(printOwner(f2,_);write('        ')),write(' '),(printOwner(f3,_);write('        ')),nl,
    ...
    write('    '),(printPro(d3,_);write('        ')),write(' |        |                                                              |        |'), write(' '),(printPro(g1,_);write('        ')),write(' '), nl,
    write('    '),write('         |________|                                                              |________|'), nl,
    write('    '),(printOwner(d2,_);write('        ')),write(' |   D2   |                                                              |   G2   |'), write(' '),(printOwner(g2,_);write('        ')),write(' '),nl,
    write('    '),(printPro(d2,_);write('        ')),write(' |        |                                                              |        |'), write(' '),(printPro(g2,_);write('        ')),write(' '), nl,
    write('    '),write('         |________|                                                              |________|'), nl,
    write('    '),(printOwner(d1,_);write('        ')),write(' |   D1   |                                                              |   G3   |'), write(' '),(printOwner(g3,_);write('        ')),write(' '), nl,
    write('    '),(printPro(d1,_);write('        ')),write(' |        |                                                              |        |'), write(' '),(printPro(g3,_);write('        ')),write(' '), nl,
    write('    '),write('         |________|                                                              |________|'), nl,
    ...
    write('    '),(printPro(c2,_);write('        ')),write(' |        |                                                              |        |'), write(' '),(printPro(h1,_);write('        ')),write(' '), nl,
    write('    '),write('         |________|                                                              |________|'), nl,
    write('    '),(printOwner(c1,_);write('        ')),write(' |   C1   |                                                              |   H2   |'), write(' '),(printOwner(h2,_);write('        ')),write(' '), nl,
    write('    '),(printPro(c1,_);write('        ')),write(' |        |                                                              |        |'), write(' '),(printPro(h2,_);write('        ')),write(' '), nl,
    write('    '),write('         |________|______________________________________________________________|________|'), nl,
    write('    '),write('         |   JL   |   B3   |   B2   |   B1   |   CC   |   A2   |   GC   |   A1   |   GO   |'), nl,
    write('    '),write('         |        |        |        |        |        |        |        |        |        |'), nl,
